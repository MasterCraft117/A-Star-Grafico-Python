...
#Creditos de implementacion grafica a Auctux
#https://github.com/Josephbakulikira/Astar-visualization-python

import pygame #Importa los componentes de pygame
from cell import * #Importa las funciones definidas para el dibujo de las celdas
import math #Importa funciones math para la ejecucion de ciertos calculos
from constants import * #Importa las constantes definidas como colores, tamaño de pantalla, y tamaño de celdas
from UI.setup import * #Importa las funciones de interfaz, que controlan las interacciones con el usuario
from utils import * #Importa las funciones auxiliares como calculos de distancias, esenciales para la ejecucion del algoritmo principal
...
#Definicion de nodos, inicio y final/objetivo
...
while run:
    ...
    # Astar Algorithm // Algoritmo A Star
    if pause == False:
